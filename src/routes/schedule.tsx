        ...
        <div>
          <Group gap="md" align="center">
            <Title order={2} style={{ fontSize: 28 }}>
              {dayjs(scheduleDate).format("MMMM YYYY")}
            </Title>
            <Group gap={0}>
              <ActionIcon
                variant="default"
        ...
        <Group>
          <Button.Group>
            <Button
              ...
              color={view === "day" ? "indigo.1" : undefined}
              c={view === "day" ? "indigo.9" : undefined}
              onClick={() => setView("day")}
            >
              Day
            </Button>
            <Button
              ...
              color={view === "week" ? "indigo.1" : undefined}
              c={view === "week" ? "indigo.9" : undefined}
            ...
            <Button
              ...
              color={view === "month" ? "indigo.1" : undefined}
              c={view === "month" ? "indigo.9" : undefined}
                ...
                event.display === "background" ? (
                  ...
                  <Stack gap={2} p={4} h="100%">
                    <Group justify="space-between" align="flex-start">
                      <Text
                        size="xs"
                        c={event.color ? `${event.color}.9` : undefined}
                        style={{ opacity: 0.8 }}
                      >
